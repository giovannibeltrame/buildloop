...
1. **New or re-sharpen?** If re-sharpening an existing fc (say `does-it-worth` returned "not yet"), open it. Otherwise create one:
   ```
...
- Standalone: works anywhere, and with no context it starts a fresh fc.
