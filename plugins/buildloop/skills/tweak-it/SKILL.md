...
Route a change to a shipped feature back into the loop at the cheapest correct depth. Where you re-enter *is* the lite/full decision. Apply the writing principles ([AGENTS.md §4.7](AGENTS.md)).
